...
- (void)viewDidLoad {
    ...
    NSString *str1 = nil; NSString *str2 = nil; NSString *str3 = nil;NSString *str4 = nil;NSString *str5 = nil;
    ...
    str5 = @"haha只有一行呀😁，你说呢ASwJ2O";
    _contentArray = @[str1, str2, str3, str4, str5];
    self.tableView.rowHeight = UITableViewAutomaticDimension;
